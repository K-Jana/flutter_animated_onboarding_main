...
class _LoginState extends State<Login> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _animationController = AnimationController(
      vsync: this,
      duration: AppTheme.kButtonAnimationDuration,
    );
      ...
      body: Stack(
        children: <Widget>[
          AnimatedBuilder(
            ...
            child: Container(color: AppTheme.kGrey),
          ),
          AnimatedBuilder(
            ...
            child: Container(color: AppTheme.kBlue),
          ),
          AnimatedBuilder(
            ...
            child: Container(color: AppTheme.kWhite),
          ),
          SafeArea(
            child: Padding(
              padding: const EdgeInsets.symmetric(vertical: AppTheme.kPaddingL),
              child: Column(
                children: <Widget>[
